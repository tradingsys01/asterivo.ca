      ...
      <nav className="container mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-8">
            ...
            <Link href="/services" className="text-blue-600 font-semibold">About</Link>
            <Link href="/contact?source=services-nav" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-semibold transition-colors">Free Assessment</Link>
          </div>
        </div>
      </nav>
