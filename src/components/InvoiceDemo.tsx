    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8 max-w-4xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-slate-600 dark:text-slate-300">
          Upload a sample invoice and watch AI extract all the data in seconds
        </p>
      </div>
        ...
        <div className="text-center py-12">
          <div className="inline-flex items-center space-x-3 text-blue-600 mb-4">
            ...
            <span className="text-lg font-semibold">
              {isProcessing ? 'AI is analyzing your invoice...' : 'Processing complete!'}
            </span>
          </div>
          <p className="text-slate-600 dark:text-slate-300">
            File: {file.name}
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 p-4 rounded-lg">
            <div className="flex items-center space-x-2 text-blue-700 dark:text-blue-300">
              ...
              <span className="text-sm font-medium">
                This is a demo using sample data. In production, this would process your actual invoice files.
              </span>
            </div>
          </div>
        </div>
